                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(window.Icon, { name: "map-marked-alt", className: "text-white w-5 h-5" })
                        ),
                        React.createElement(
                            'span',
                    ...
                    React.createElement(
                        ...
                        navLinks.map(link => 
                            React.createElement(
                                ...
                                React.createElement(window.Icon, { name: link.icon, size: 16 }),
                                link.label
                            )
                        )
                    ),
                        ...
                        user ? React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(window.Icon, { name: "bell", size: 20 }),
                                ...
                                showNotifications && React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        (!notifications || notifications.length === 0) ? React.createElement(
                                            'div',
                                            { className: "p-8 text-center text-gray-500" },
                                            React.createElement(window.Icon, { name: "bell-slash", size: 32, className: "mx-auto mb-2 opacity-50" }),
                                                ...
                                                React.createElement(
                                                    ...
                                                    React.createElement(
                                                        ...
                                                        React.createElement(window.Icon, { 
                                                            name: notif.type === 'business' ? 'building' : (notif.icon || 'bell'), 
                                                            size: 14,
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(window.Icon, { name: "chevron-down", size: 16, className: "text-gray-400" })
                                ),
                                showUserMenu && React.createElement(
                                    ...
                                    [
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(window.Icon, { name: item.icon, size: 16 }),
                                            item.label
                                        )
                                    )
                                )
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            isOpen 
                                ? React.createElement(window.Icon, { name: "times", size: 24 })
                                : React.createElement(window.Icon, { name: "bars", size: 24 })
                        )
                    )
                )
            ),
            ...
            isOpen && React.createElement(
                ...
                navLinks.map(link =>
                    React.createElement(
                        ...
                        React.createElement(window.Icon, { name: link.icon, size: 18 }),
                        link.label
                    )
                ),
                ...
                user ? React.createElement(
                    ...
                    [
                        ...
                        React.createElement(
                            ...
                            React.createElement(window.Icon, { name: item.icon, size: 18 }),
                            item.label
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(window.Icon, { name: "sign-out-alt", size: 18 }),
                        "Logout"
                    )
                ) : React.createElement(
                    'button',
