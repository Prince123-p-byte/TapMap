                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(window.Icon, { name: "zap", size: 14 }),
                            ` ${stats.totalBusinesses || 50}+ Businesses on tapMap`
                        ),
                        React.createElement(
                            'h1',
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                "Explore Businesses ",
                                React.createElement(window.Icon, { name: "arrow-right", size: 20 })
                            )
                        )
                    )
                )
                        ...
                        features.map((feature, i) =>
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(window.Icon, { name: feature.icon, size: 32 })
                                ),
                                React.createElement(
                                    'h3',
            ...
            featured.length > 0 && React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        "View All ",
                        React.createElement(window.Icon, { name: "arrow-right", size: 18 })
                    )
                ),
                React.createElement(
                    'div',
                    { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8" },
                    featured.map(biz =>
                        React.createElement(window.BusinessCard, {
                            key: biz.id,
                            business: biz,
