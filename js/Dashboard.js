...
(function() {
    const Dashboard = ({ businesses, onNavigate, baseUrl = 'https://prince123-p-byte.github.io/TapMap' }) => {
        ...
        const calculateAnalytics = () => {
            ...
            const totalQRScans = businesses.reduce((sum, biz) => sum + (biz.qr_scans || biz.qrScans || 0), 0);
            ...
            setAnalytics({
                ...
                viewsChange: calculateChange(totalViews),
                clicksChange: calculateChange(totalClicks),
                scansChange: calculateChange(totalQRScans),
                ratingChange: calculateChange(parseFloat(avgRating))
            });
        };
        ...
        const generateRecentActivity = () => {
            ...
            businesses.forEach(biz => {
                ...
                if ((biz.qr_scans || biz.qrScans || 0) > 0) {
                    activities.push({
        ...
        const handleRegenerateQR = async (business) => {
            ...
            try {
                setQrData(`https://api.qrserver.com/v1/create-qr-code/?size=${qrSettings.size}x${qrSettings.size}&data=${encodeURIComponent(businessUrl)}&color=${qrSettings.foreground.substring(1)}&bgcolor=${qrSettings.background.substring(1)}&margin=${qrSettings.margin}`);
                setShowQRModal(true);
            } catch (error) {
        ...
        const downloadQR = () => {
            ...
            link.download = `${selectedBusiness.name.replace(/[^a-z0-9]/gi, '_').toLowerCase()}-qrcode.png`;
            link.href = qrData;
            link.click();
            ...
            window.supabase
                ...
                .catch(error => console.error('Error updating QR scan count:', error));
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        `Welcome back, ${businesses.length > 0 ? 'Business Owner' : 'New User'}`
                    ),
                    React.createElement(
                        'p',
                ...
                businesses.length > 0 && React.createElement(
                    ...
                    React.createElement(
                        ...
                        { 
                            variant: "secondary", 
                            icon: "bell",
                            onClick: () => window.Toast.show('Notifications panel coming soon', 'info')
                        },
                        "Notifications"
                    ),
                    React.createElement(
            ...
            React.createElement(
                ...
                stats.map((stat, i) =>
                    React.createElement(window.StatCard, { key: i, ...stat })
                )
            ),
                    ...
                    quickActions.map((action, i) =>
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(window.Icon, { name: action.icon, size: 20 })
                            ),
                            React.createElement(
                                'span',
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        recentActivity.length > 0 && React.createElement(
                            ...
                            { 
                                ...
                                onClick: () => window.Toast.show('View all activity coming soon', 'info')
                            },
                            "View All"
                        )
                    ),
                    recentActivity.length === 0 ? React.createElement(
                        ...
                        React.createElement(window.Icon, { name: "history", size: 32, className: "mx-auto mb-2 opacity-50" }),
                        ...
                        recentActivity.map((activity, i) =>
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(window.Icon, { name: activity.icon, size: 16 })
                                ),
                                React.createElement(
                                    'div',
                ...
                React.createElement(
                    ...
                    topPerforming.length === 0 ? React.createElement(
                        'div',
                        { className: "text-center py-8 text-gray-500" },
                        React.createElement(window.Icon, { name: "chart-line", size: 32, className: "mx-auto mb-2 opacity-50" }),
                        ...
                        topPerforming.map((business, i) => {
                            ...
                            return React.createElement(
                                ...
                                React.createElement(
                                    'div',
                                    { className: "w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-600 to-purple-600 text-white flex items-center justify-center font-bold flex-shrink-0 overflow-hidden" },
                                    business.logo ? 
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'p',
                                        { className: "text-xs text-gray-500" },
                                        `${(business.views || 0).toLocaleString()} views • ${(business.clicks || 0).toLocaleString()} clicks`
                                    )
                                ),
                                React.createElement(
                                    'div',
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        "Manage All",
                        React.createElement(window.Icon, { name: "arrow-right", size: 12 })
                    )
                ),
                businesses.length === 0 ? React.createElement(
                    'div',
                    { className: "text-center py-12 text-gray-500" },
                    React.createElement(window.Icon, { name: "building", size: 48, className: "mx-auto mb-3 opacity-50" }),
                    ...
                    businesses.map(business =>
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'div',
                                    { className: "w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 text-white flex items-center justify-center font-bold text-lg flex-shrink-0 overflow-hidden" },
                                    business.logo ? 
                                        React.createElement('img', { 
                                            src: business.logo, 
                                            alt: business.name,
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'p',
                                        { className: "text-xs text-gray-500" },
                                        `Created: ${formatDate(business.created_at || business.createdAt)}`
                                    )
                                )
                            ),
                            React.createElement(
                                ...
                                React.createElement('img', {
                                    ...
                                    onError: (e) => { e.target.src = 'https://via.placeholder.com/100x100?text=QR'; }
                                })
                            ),
                            React.createElement(
                                'div',
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(window.Icon, { name: "eye", size: 12 }),
                                ...
                                React.createElement(
                                    'span',
                                    { className: "flex items-center gap-1" },
                                    React.createElement(window.Icon, { name: "qrcode", size: 12 }),
                                    (business.qr_scans || business.qrScans || 0).toLocaleString(),
                                    " scans"
                                )
                            ),
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(window.Icon, { name: "edit", size: 12 }),
                                    "Edit"
                                )
                            )
                        )
            ...
            React.createElement(
                ...
                businesses.length === 0 ? React.createElement(
                    ...
                    React.createElement(window.Icon, { name: "chart-line", size: 48, className: "mb-2 opacity-50" }),
                ...
                selectedBusiness && React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement('img', {
                                ...
                                onError: (e) => { 
                                    e.target.src = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(`${baseUrl}/?business=${selectedBusiness.id}`)}`;
                                }
                            })
                        ),
                        React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(window.Icon, { name: "download", size: 16 }),
                            "Download QR"
                        ),
                        React.createElement(
                            'button',
